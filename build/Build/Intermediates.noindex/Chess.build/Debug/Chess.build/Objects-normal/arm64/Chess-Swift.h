...
SWIFT_CLASS_NAMED("ChessGameEntity")
@interface ChessGameEntity : NSManagedObject
...
@interface ChessGameEntity (SWIFT_EXTENSION(Chess))
@property (nonatomic, copy) NSString * _Nullable blackPlayer;
@property (nonatomic, copy) NSString * _Nullable date;
@property (nonatomic, copy) NSDate * _Nullable dateCreated;
@property (nonatomic, copy) NSString * _Nullable eco;
...
@property (nonatomic, copy) NSString * _Nullable pgnString;
@property (nonatomic, copy) NSString * _Nullable result;
@property (nonatomic, copy) NSString * _Nullable round;
@property (nonatomic, copy) NSString * _Nullable site;
@property (nonatomic, copy) NSString * _Nullable title;
@property (nonatomic, copy) NSString * _Nullable whitePlayer;
@end

@class NSCoder;
@class NSEvent;

SWIFT_CLASS("_TtC5Chess19MouseTrackingNSView")
@interface MouseTrackingNSView : NSView
...
SWIFT_CLASS("_TtC5Chess14RightClickView")
